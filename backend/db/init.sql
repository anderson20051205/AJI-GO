IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'AJIGO')
...
-- TABLA: ROLES
CREATE TABLE ROLES (
    RolID         INT          IDENTITY(1,1) NOT NULL,  -- PK ✅
...
CREATE TABLE USUARIOS (
    UsuarioID     INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
    RolID         INT           NOT NULL,                 -- FK ✅
...
CREATE TABLE SECTORES (
    SectorID  INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
...
CREATE TABLE RESTAURANTES (
    RestauranteID     INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
...
CREATE TABLE CATEGORIAS (
    CategoriaID     INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
...
CREATE TABLE PRODUCTOS (
    ProductoID     INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
    SucursalID     INT           NOT NULL,                 -- FK ✅
...
CREATE TABLE TIPO_ENTREGA (
    TipoEntregaID  INT          IDENTITY(1,1) NOT NULL,  -- PK ✅
...
CREATE TABLE ESTADOS_PEDIDO (
    EstadoPedidoID INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
...
CREATE TABLE METODOS_PAGO (
    MetodoPagoID INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
...
CREATE TABLE ESTADO_ENVIO (
    EstadoID  INT          IDENTITY(1,1) NOT NULL,  -- PK ✅
    EstadoSTR NVARCHAR(50) NOT NULL,
...
CREATE TABLE DIRECCION_USUARIOS (
    DireccionUsuarioID INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
    UsuarioID          INT           NOT NULL,                  -- FK ✅
    SectorID           INT           NOT NULL,                  -- FK ✅
...
CREATE TABLE PEDIDOS (
    PedidoID           INT      IDENTITY(1,1) NOT NULL,  -- PK ✅
    UsuarioID          INT      NOT NULL,                  -- FK ✅
    SucursalID         INT      NOT NULL,                  -- FK ✅
    DireccionUsuarioID INT      NULL,
    TipoEntregaID      INT      NOT NULL,                  -- FK ✅
    EstadoPedidoID     INT      NOT NULL,                  -- FK ✅
...
CREATE TABLE DETALLE_PEDIDO (
    DetalleID      INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
    PedidoID       INT           NOT NULL,                  -- FK ✅
    ProductoID     INT           NOT NULL,                  -- FK ✅
...
-- TABLA: PAGOS
CREATE TABLE PAGOS (
    PagoID         INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
    PedidoID       INT           NOT NULL,                  -- FK ✅
    MetodoPagoID   INT           NOT NULL,                  -- FK ✅
...
CREATE TABLE RESENAS (
    ResenaID    INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
    PedidoID    INT           NOT NULL,                  -- FK ✅
...
-- TABLA: ENVIOS
CREATE TABLE ENVIOS (
    EnvioID      INT      IDENTITY(1,1) NOT NULL,  -- PK ✅
    PedidoID     INT      NOT NULL,                  -- FK ✅
    UsuarioID    INT      NOT NULL,                  -- FK ✅
...
CREATE TABLE HISTORIAL_PEDIDOS (
    HistorialID    INT      IDENTITY(1,1) NOT NULL,  -- PK ✅
    PedidoID       INT      NOT NULL,                  -- FK ✅
    EstadoPedidoID INT      NOT NULL,                  -- FK ✅
...
CREATE TABLE CARRITOS (
    CarritoID          INT      IDENTITY(1,1) NOT NULL,  -- PK ✅
    UsuarioID          INT      NOT NULL,                  -- FK ✅
    SucursalID         INT      NOT NULL,                  -- FK ✅
...
CREATE TABLE CARRITO_ITEMS (
    ItemID     INT           IDENTITY(1,1) NOT NULL,  -- PK ✅
    CarritoID  INT           NOT NULL,                  -- FK ✅
    ProductoID INT           NOT NULL,                  -- FK ✅
    Cantidad   INT           NOT NULL,
    Notas      NVARCHAR(300) NULL,
...
-- ✅ FIX: HistorialID es IDENTITY, no se inserta manualmente
...
BEGIN
    ...
    BEGIN
        ...
        RETURN;
    END
    -- ✅ FIX: ItemID es IDENTITY, no se inserta manualmente
...
BEGIN
    ...
    BEGIN
        ...
        RETURN;
    END
    -- ✅ FIX: ResenaID es IDENTITY, no se inserta manualmente
